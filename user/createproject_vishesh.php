<?php
 session_start();
    ...
    $zv=2;
    $r=$func->select_with_condition("*","club_heir","zval>=$zv");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="wrapper">
        ...
        <form id='login' method="post">
            ...
            <div class="container">
                ...
                <!-- <input type="text" id="proj_name" name="proj_name"/> -->
					<input type='text' id="proj_name" name="proj_name" placeholder="Name"/><br/>
            ...
            <div class="container">
                ...
                <input type='textarea' id="proj_desc" name="proj_desc" placeholder="Description" /><br/>
        ...
        <div class="container">
            ...
            <select id="authval" name="authval">
        </div>
        <option value=0 disabled selected hidden>Club member position</option>
    <?php
...
echo"why";
    ...
    $str="INSERT INTO project(project_name,project_description,authZval,FinishID,visibility) VALUES ('{$proj_name}','{$proj_desc}','{$proj_auth}',{$proj_finish},{$proj_auth});";?>

   <!-- <h3> <?php echo $str;?></h3> -->
   <?php 
   $r= mysqli_query($con,$str) or die("why");

    mysqli_close($con);
    if($r==false){
    ?>  
   <h2> <?php echo "mysqli_error($link);";?></h2>
   <?php
    } else{
        $con=$func->connect();
